(() => {
  const SITE = 'maijishan';
  const DATA_ALL = './data/maijishan-all-caves.json';
  const DATA_NOTES = './data/maijishan-caves.json';
  const DATA_SUPP = './data/maijishan-supplements.json';
